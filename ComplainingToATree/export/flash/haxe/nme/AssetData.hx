...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/data/beep.wav", nme.NME_assets_data_beep_wav);
			...
			className.set ("assets/png/960p/complaint_box_full_960p.png", nme.NME_assets_png_960p_complaint_box_full_960p_png);
			type.set ("assets/png/960p/complaint_box_full_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/tree_1_full_960p.png", nme.NME_assets_png_960p_tree_1_full_960p_png);
			type.set ("assets/png/960p/tree_1_full_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/tree_1_select_full_960p.png", nme.NME_assets_png_960p_tree_1_select_full_960p_png);
			type.set ("assets/png/960p/tree_1_select_full_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/tree_2_full_960p.png", nme.NME_assets_png_960p_tree_2_full_960p_png);
			type.set ("assets/png/960p/tree_2_full_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/tree_2_select_full_960p.png", nme.NME_assets_png_960p_tree_2_select_full_960p_png);
			type.set ("assets/png/960p/tree_2_select_full_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/tree_3_full_960p.png", nme.NME_assets_png_960p_tree_3_full_960p_png);
			type.set ("assets/png/960p/tree_3_full_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/tree_3_select_full_960p.png", nme.NME_assets_png_960p_tree_3_select_full_960p_png);
			type.set ("assets/png/960p/tree_3_select_full_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/tree_4_full_960p.png", nme.NME_assets_png_960p_tree_4_full_960p_png);
			type.set ("assets/png/960p/tree_4_full_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/tree_4_select_full_960p.png", nme.NME_assets_png_960p_tree_4_select_full_960p_png);
			type.set ("assets/png/960p/tree_4_select_full_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/tree_5_full_960p.png", nme.NME_assets_png_960p_tree_5_full_960p_png);
			type.set ("assets/png/960p/tree_5_full_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/tree_5_select_full_960p.png", nme.NME_assets_png_960p_tree_5_select_full_960p_png);
			type.set ("assets/png/960p/tree_5_select_full_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_data_beep_wav extends flash.media.Sound { }
...
class NME_assets_png_960p_complaint_box_full_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_tree_1_full_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_tree_1_select_full_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_tree_2_full_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_tree_2_select_full_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_tree_3_full_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_tree_3_select_full_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_tree_4_full_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_tree_4_select_full_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_tree_5_full_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_tree_5_select_full_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }

...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/png/960p/background_line_960p.png", nme.NME_assets_png_960p_background_line_960p_png);
			type.set ("assets/png/960p/background_line_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/rice_960p.png", nme.NME_assets_png_960p_rice_960p_png);
			type.set ("assets/png/960p/rice_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/rice_cup_bg_960p.png", nme.NME_assets_png_960p_rice_cup_bg_960p_png);
			type.set ("assets/png/960p/rice_cup_bg_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/rice_cup_fg_960p.png", nme.NME_assets_png_960p_rice_cup_fg_960p_png);
			type.set ("assets/png/960p/rice_cup_fg_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/sesame_960p.png", nme.NME_assets_png_960p_sesame_960p_png);
			type.set ("assets/png/960p/sesame_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/sesame_cup_bg_960p.png", nme.NME_assets_png_960p_sesame_cup_bg_960p_png);
			type.set ("assets/png/960p/sesame_cup_bg_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/sesame_cup_fg_960p.png", nme.NME_assets_png_960p_sesame_cup_fg_960p_png);
			type.set ("assets/png/960p/sesame_cup_fg_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_png_960p_background_line_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_rice_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_rice_cup_bg_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_rice_cup_fg_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_sesame_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_sesame_cup_bg_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_sesame_cup_fg_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }

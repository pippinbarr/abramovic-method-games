...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/png/960p/bird_sheet_960p.png", nme.NME_assets_png_960p_bird_sheet_960p_png);
			type.set ("assets/png/960p/bird_sheet_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/birds_960p.png", nme.NME_assets_png_960p_birds_960p_png);
			type.set ("assets/png/960p/birds_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/rain_960p.png", nme.NME_assets_png_960p_rain_960p_png);
			type.set ("assets/png/960p/rain_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/snow_1_960p.png", nme.NME_assets_png_960p_snow_1_960p_png);
			type.set ("assets/png/960p/snow_1_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/snow_2_960p.png", nme.NME_assets_png_960p_snow_2_960p_png);
			type.set ("assets/png/960p/snow_2_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/png/960p/wind_960p.png", nme.NME_assets_png_960p_wind_960p_png);
			type.set ("assets/png/960p/wind_960p.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_png_960p_bird_sheet_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_birds_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_rain_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_snow_1_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_snow_2_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_960p_wind_960p_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
